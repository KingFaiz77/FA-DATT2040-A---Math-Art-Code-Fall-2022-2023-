...
void setup()
{
  ...
  //Change songs
  song = minim.loadFile("Lil_Uzi_Vert_Just_Wanna_Rock.mp3");
  
  //Pick any songs... make sure they are in the file folder too. Copy from below.
  

//  Song 1: SKYBOX
//  Song 2: Lil_Uzi_Vert_Just_Wanna_Rock
//  Song 3: Kendrick_Lamar_N95
//  Song 4: Faiz - Ugly God Type Beat
//  Song 5: Travis_Scott_SICKO_MODE
//  Song 6: #257 silence VHIP
//  Song 7: #177 jugg
//  Song 8: #173 REDU
  ...
  for (int i = 2; i < nbMurs; i+=4) {
   murs[i] = new Mur(width/2, height, width, 50); 
  }
